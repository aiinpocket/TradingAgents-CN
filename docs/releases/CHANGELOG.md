...
## [v0.1.13] - 2025-08-2 - 原生OpenAI支援与Google AI全面集成
...
- **自定義模型**: 支援輸入任意OpenRouter模型ID，满足個性化需求
...
- **智能恢複**: 支援從URL參數或Session State恢複配置
- **詳細日誌**: 完整的配置變化追蹤和調試信息
...
- **多種顯示模式**: 支援Streamlit、静態、統一等多種進度顯示方式
- **步驟智能识別**: 根據日誌消息自動识別當前分析步驟和進度

#### 📊 查看分析報告功能

- **一键查看報告**: 分析完成後顯示"📊 查看分析報告"按钮
- **智能結果恢複**: 自動從存储中恢複分析結果並格式化顯示
- **狀態持久化**: 支援页面刷新後重新查看歷史分析報告
...
- **代碼识別**: 修複5位數字代碼识別規則 (如09988.HK阿里巴巴)
...
- **支援**: Web應用、MongoDB、Redis、管理界面一键部署
