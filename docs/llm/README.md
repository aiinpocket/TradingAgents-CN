...
### 已集成
- **OpenAI** - GPT-4、GPT-4o-mini 系列模型
- **Anthropic** - Claude 4 系列模型
- **Custom OpenAI** - 自定義 OpenAI 相容端點
...
### 添加新LLM提供商
1. 在 `trading_graph.py` 的 `__init__` 中添加提供商分支
2. 安裝對應的 LangChain 客戶端套件
3. 更新前端模型選擇界面
4. 編寫完整的測試用例
5. 更新相關文檔
