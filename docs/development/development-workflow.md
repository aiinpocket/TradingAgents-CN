...
本文檔詳細說明 TradingAgents 中文增強版的標準開發工作流程，確保團隊協作的一致性和代碼品質。
...
```bash
# 創建發布分支
python scripts/branch_manager.py create release v1.2.0-cn -d "v1.2.0中文增強版發布"
...
# 創建版本標簽
git tag -a v1.2.0-cn -m "TradingAgents中文增強版 v1.2.0"
