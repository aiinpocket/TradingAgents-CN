...
- **v0.5.0** (2026-02-27): WCAG 2.5.8 觸控目標修復(44px)、快取時鐘回調防護、Markdown 表格 RWD 溢出修復、focus-visible 一致化、AI 趨勢分析跨 tab 語言切換修復、SignalProcessor 去 LLM 化（純正則提取）、未使用匯入清理、market_analyst 裝飾器一致化、CSS 觸控回饋(:active)、暗色模式對比度強化、MongoDB 非阻塞儲存、SSE 事件驅動通知、$ 前綴 CSS specificity 修復、ARIA 無障礙修正、版本號統一
