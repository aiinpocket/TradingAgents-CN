...
#### i18n 國際化
- **159 翻譯鍵**: zh-TW / en 完全對稱，後端 33 key 雙語完整
...
- **v0.4.5** (2026-02-27): 節點級別即時進度回報、多空/風險並行辯論、分析師直接工具呼叫、工具結果快取去重、快取 TTL 優化、圖結構精簡、SSE try/finally 清理、compositor-only 動畫、SSR 預渲染 CLS 0.00、CSP 構建器提取消除重複、版本常數化、術語校正共用模組化、詞庫擴充（+8 組台灣慣用語）
