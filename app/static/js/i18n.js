...
const I18N_MESSAGES = {
  'zh-TW': {
    ...
    'analysis.symbol_placeholder': '如 AAPL、TSLA',
    'analysis.date': '分析日期',
    ...
    'analysis.start': '開始分析',
    'analysis.select_module': '請選擇至少一個分析模組',
    ...
    'analysis.cancel': '取消',
    'analysis.cancel_confirm': '再按一次確認取消',
    'analysis.timeout_10min': '已超過 10 分鐘，如長時間無進度可考慮取消重試',
    'analysis.timeout_20min': '已超過 20 分鐘，建議取消並降低研究深度後重試',
    ...
    'history.load_failed': '載入歷史記錄失敗，請稍後重試',
  ...
  'en': {
    ...
    'analysis.symbol_placeholder': 'e.g. AAPL, TSLA',
    'analysis.date': 'Date',
    ...
    'analysis.select_module': 'Please select at least one analysis module',
    ...
    'analysis.cancel_confirm': 'Click again to confirm cancel',
    'analysis.timeout_10min': 'Over 10 min elapsed. Consider canceling if no progress.',
    'analysis.timeout_20min': 'Over 20 min elapsed. Try canceling and reducing depth.',
    ...
    'history.load_failed': 'Failed to load history. Please try again.',
