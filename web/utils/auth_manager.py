...
class AuthManager:
    ...
    def restore_from_cache(self, user_info: Dict, login_time: float = None) -> bool:
        ...
        try:
            ...
            logger.error(f"❌ 從前端緩存恢複登錄狀態失败: {e}")
            return False
